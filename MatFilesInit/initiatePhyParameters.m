...
phyParams = addNewParam(phyParams,'rangeForVehicleDensity',100,'Awareness range (m)','integer',fileCfg,varargin{1}{1});

% [maxChanUtil, minChanUtil]
% preferred CBP Range
phyParams = addNewParam(phyParams,'maxChanUtil',0.8,'Max Channel Utilization (0~1)','double',fileCfg,varargin{1}{1});
phyParams = addNewParam(phyParams,'minChanUtil',0.5,'Min Channel Utilization (0~1)','double',fileCfg,varargin{1}{1});

% [smoothingFactor]
phyParams = addNewParam(phyParams,'smoothingFactor',0.5,'Smoothing Factor','double',fileCfg,varargin{1}{1});

% [smoothingFactorForITT]
phyParams = addNewParam(phyParams,'smoothingFactorForITT',0.5,'smoothingFactorForITT','double',fileCfg,varargin{1}{1});
...
% yeomyung
phyParams = addNewParam(phyParams,'maxPtx_dBm',23,'Transmitted power (dBm)','double',fileCfg,varargin{1}{1});
phyParams = addNewParam(phyParams,'minPtx_dBm',10,'Transmitted power (dBm)','double',fileCfg,varargin{1}{1});
...
if ~simParams.useLTE
    ...
    phyParams = addNewParam(phyParams,'MCS',5,'Modulation and coding scheme','integer',fileCfg,varargin{1}{1});
...
% phyParams = addNewParam(phyParams,'stdDevShadowLOS_dB',0,'Standard deviation of shadowing in LOS (dB)','integer',fileCfg,varargin{1}{1});
