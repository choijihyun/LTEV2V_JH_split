function [RXpower,CHgain,Shadowing_dB,X,Y]  = computeRXpowerWinner(IDvehicle,distance,PtxERP_RB,Gr,Xvehicle,Yvehicle,XminMap,YmaxMap,StepMap,...
    GridMap,fileObstaclesMap,Shadowing_dB,dUpdate,stdDevShadowLOS_dB,stdDevShadowNLOS_dB, snap, RBsBeacon)
...
PtxERP_RB_dBm = 10*log10(PtxERP_RB) + 30;
RXpower_dB = 10 * log10(RXpower);

%jihyun - add from YM
RXpower_RB = RXpower;

% RXpower = RXpower_RB * (RBsBeacon / 2);

RXpower_dB__ = 10 * log10(RXpower);
