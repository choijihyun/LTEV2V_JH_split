...
if phyParams.ifAdjacent
    ...
    if phyParams.sizeSubchannel ~= -1
        ...
        appParams.NsubchannelsBeacon = ceil((appParams.RBsBeacon/2+2)/phyParams.sizeSubchannel);
        
        % Find number of RBs per subchannel (or multiple)
        phyParams.RBsBeaconSubchannel = appParams.NsubchannelsBeacon*phyParams.sizeSubchannel;
        ...
        appParams.NsubchannelsBeacon = combinations(bestIndex,3);
    ...
    if phyParams.sizeSubchannel ~= -1
        ...
        appParams.NsubchannelsBeacon = ceil((appParams.RBsBeacon/2)/phyParams.sizeSubchannel);
        ...
        [appParams.NsubchannelsBeacon, bestIndex] = min(combinations(:,3));
        phyParams.RBsBeaconSubchannel = combinations(bestIndex,1);
...
appParams.NbeaconsT = floor(appParams.Tbeacon/phyParams.Tsf);
